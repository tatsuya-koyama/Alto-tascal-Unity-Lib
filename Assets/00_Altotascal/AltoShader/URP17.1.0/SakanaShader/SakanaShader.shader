...
Shader "Altotascal/URP 17.1.0/Sakana Shader"
{
    ...
    Properties
    {
        ...
        _UvWindStrength("UV Wind Strength", Range(0.0, 10.0)) = 0.0
        _UvWindSpeed("UV Wind Speed", Range(0.0, 10.0)) = 0.0
        _UvWindGaleStrength("UV Wind (Gale) Strength", Range(0.0, 10.0)) = 0.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Includes
            #include "SakanaShader-Input.hlsl"
            #include "SakanaShader-ForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // Includes
            #include "SakanaShader-Input.hlsl"
            #include "SakanaShader-ShadowCaster.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // Includes
            #include "SakanaShader-Input.hlsl"
            #include "SakanaShader-DepthNormalsPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "AltoLib.ShaderGUI.SakanaShaderGUI"
}

#ifndef SAKANA_SHADER_17_DEPTH_NORMALS_INCLUDED
#define SAKANA_SHADER_17_DEPTH_NORMALS_INCLUDED
...
struct Varyings
{
    ...
    float2 uv              : TEXCOORD1;
    float3 positionWS      : TEXCOORD5;    //+++ AltoShader Custom
...
Varyings DepthNormalsVertex(Attributes input)
{
    ...
    output.positionWS = positionWS;  //+++ AltoShader Custom

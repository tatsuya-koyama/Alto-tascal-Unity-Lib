#ifndef ALTO_SHADER_FORWARD_PASS_INCLUDED
#define ALTO_SHADER_FORWARD_PASS_INCLUDED
...
Varyings LitPassVertexSimple(Attributes input)
{
    ...
    {
        half noiseFactor = max(output.cubicColor.w - _Mirage1, 0);
...
half4 LitPassFragmentSimple(Varyings input) : SV_Target
{
    ...
    if (_MirageOn > 0 && _Mirage2 > 0)
    {
        ...
        half d = input.cubicColor.w / _Mirage2;

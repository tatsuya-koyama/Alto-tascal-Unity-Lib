...
";
        ...
        {
            return RepeatStr(indentUnit, indentLevel);
        }
        ...
        )
        {
            ...
            foreach (string symbol in symbols)
            {
                ...
                {
                    string spacing = alignEqual ? RepeatStr(" ", maxSymbolLength - symbol.Length) : "";
        ...
        public void Generate()
        {
            ...
            Debug.Log($"Generate Code : { outPath }");
            ...
            Debug.Log("<color=#33ee00>Generate Code Completed.</color>");
        }
